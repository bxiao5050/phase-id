  ...
  render() {
    ...
    return <div className="userInfo">
      ...
      <div className="wrap-info">
        <Route path="/:curPath" render={({ match, history }) => {
          return <Header App={app} match={match} history={history} />
        }} />
        <div className="info-content">
          <Switch>
            <Route path="/payment-history" render={({ history }) => <PaymentHistory history={history} App={app} />} />
            <Route path="/change-password" render={() => <Changepass App={app} />} />
            <Route path="/visitor-upgrade" render={() => <VisitorUpgrade App={app} />} />
            <Route path="/main" render={({ history }) =>
              <Main App={app} history={history} />
            } />
          </Switch>
        </div>
      </div>

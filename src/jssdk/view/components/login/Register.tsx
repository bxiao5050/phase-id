    ...
    return (
      <div className='content win-register'>
        ...
        <div className='box-input'>
          <div
            className='line-input rg-username'
         ...
         onFocus={() => this.focusInput("userName")} */
          ...
          <div className='line-input rg-password one'>
            ...
            <input
              ...
              id='password1'
              onChange={e => this.onChange(e)}
              onBlur={() => this.blurInput('password1')}
              onFocus={() => this.focusInput('password1')}
            />
            <div
              className={'icon-close ' + (this.state.closePass1 ? 'active' : '')}
          ...
          <div className='line-input rg-password'>
            ...
            <input
              ...
              onChange={e => this.onChange(e)}
              id='password2'
              onBlur={() => this.blurInput('password2')}
              onFocus={() => this.focusInput('password2')}
            />
            <div
              className={'icon-close ' + (this.state.closePass2 ? 'active' : '')}
        ...
        <a className='btn-register' onClick={this.register}>

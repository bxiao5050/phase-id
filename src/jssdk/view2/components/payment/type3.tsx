...
export default class Type3 extends React.Component<paymentProps, {}, any> {
  ...
  render() {
    ...
    // debugger
    return (
      <div className='payment-nav type-3'>
        ...
        <ul className='type3-item'>
          ...
          <div className='type3-product-down'>{source.description}</div>
        </ul>
      </div>
    );
  }
